...
const SECTION_LABEL = '법률지식인';
const SECTION_SUBTITLE = '실생활에서 자주 묻는 법률 Q&A를 전문가가 답합니다.';

interface Props { articles: Article[] }

export default function KnowledgePage({ articles }: Props) {
  return (
    <Layout>
      <SeoHead
        config={SITE_CONFIG}
